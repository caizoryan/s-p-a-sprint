...
export let About = () => {
  ...
  return _("div.about")(description, first, second);
};
...
let clients = () => {
  ...
  return _("div.about__clients")(h1("Clients"), client_elements);
};
...
let communications = () => {
  ...
  return _("div.about__communications")(
    h1("Communications"),
...
let network = () => {
  ...
  return _("div.about__network")(h1("Network"), network_elements);
};

let team = () => {
  mounted(() => fade_in(".about__team"));

  let name = _("div.about__subhead");
...
let serivces = () => {
  ...
  let services = _("div.about__subhead");
